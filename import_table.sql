-- 1. Bảng Product
INSERT INTO Product (name, description, brand, category, specification, price, image_url) VALUES
('Product A', 'Mô tả sản phẩm A', 'Brand A', 'Category A', 'Spec A', 100.00, 'http://example.com/a.jpg'),
...
-- 2. Bảng Warehouse
INSERT INTO Warehouse (location, capacity, description) VALUES
('Location A', 1000, 'Mô tả kho A'),
...
INSERT INTO InventoryTransaction (inventory_id, transaction_type, quantity, description) VALUES
(1, 'inbound', 10, 'Nhập kho ban đầu'),
(2, 'outbound', 5, 'Xuất kho giao hàng'),
(3, 'inbound', 15, 'Nhập thêm hàng');

-- 5. Bảng ProductionOrder (tham chiếu product_id)
INSERT INTO ProductionOrder (product_id, quantity, start_date, end_date, status) VALUES
(1, 100, '2025-01-01', '2025-01-10', 'Completed'),
(2, 200, '2025-02-01', '2025-02-15', 'In Progress'),
(3, 150, '2025-03-01', '2025-03-10', 'Pending');

-- 6. Bảng ProductionStep (tham chiếu order_id)
INSERT INTO ProductionStep (order_id, step_number, description, start_time, end_time, status) VALUES
(1, 1, 'Trộn nguyên liệu', '2025-01-01 08:00:00', '2025-01-01 10:00:00', 'Completed'),
...
INSERT INTO Employee (name, department_id, contact_info, hire_date, salary) VALUES
('Alice', 1, 'alice@example.com', '2020-05-10', 50000.00),
...
INSERT INTO Equipment (name, type, department_id, purchase_date, maintenance_schedule, status) VALUES
('Printer A', 'Printer', 1, '2023-01-15', 'Monthly', 'Active'),
...
INSERT INTO RawMaterial (name, description, supplier_id, unit, current_stock, reorder_level) VALUES
('Material A', 'Nguyên liệu A chất lượng cao', 1, 'kg', 500, 100),
...
INSERT INTO QualityControl (product_id, production_order_id, inspection_date, inspector_id, result, notes) VALUES
(1, 1, '2025-01-11', 1, 'Pass', 'Mọi thứ ổn định'),
...
INSERT INTO SecurityLog (event_type, event_date, description, employee_id, location) VALUES
('Login', '2025-01-05 08:00:00', 'Đăng nhập hệ thống', 1, 'Văn phòng chính'),
...
INSERT INTO MaintenanceLog (equipment_id, maintenance_date, maintenance_type, performed_by, maintenance_description, cost, next_scheduled_date, status) VALUES
(1, '2025-01-10', 'Kiểm tra định kỳ', 1, 'Kiểm tra hiệu suất máy in', 100.00, '2025-02-10', 'Completed'),
...
INSERT INTO `User` (username, password_hash, email, employee_id, status) VALUES
('user1', 'hash1', 'user1@example.com', 1, 'Active'),
...
INSERT INTO Report (report_name, report_type, created_by, parameters, summary, file_url) VALUES
('Sales Report', 'Monthly', 1, '{"month":"January"}', 'Báo cáo bán hàng tháng', 'http://example.com/report1.pdf'),
